"""Test mnist classifier with summary data in TensorBoard"""
import argparse
import os
import sys
...
def parse_args():
  ...
  parser.add_argument(
      '--data_dir',
      type=str,
      default=os.path.join(os.getcwd(), "../mnist"),
      help='Directory for storing input data')
  parser.add_argument(
      '--log_dir',
      type=str,
      default=os.path.join(os.getcwd(), "../mnist", 'logs/mnist_with_summaries'),
      help='Summaries log directory')
  return parser.parse_args()

def train():
  """ Train mnist classification network and get summary data.
  """
  # Import data
